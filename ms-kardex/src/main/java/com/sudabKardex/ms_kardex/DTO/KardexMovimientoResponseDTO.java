...
public class KardexMovimientoResponseDTO {
    ...
    public String toString() {
        return "KardexMovimientoResponseDTO{idMovimiento=" + idMovimiento + ", idKardex=" + idKardex + ", tipoMovimiento='" + tipoMovimiento + "', cantidad=" + cantidad + ", saldoStock=" + saldoStock + ", fechaMovimiento=" + fechaMovimiento + ", documentoReferencia='" + documentoReferencia + "', observaciones='" + observaciones + "'}";
    }
}
