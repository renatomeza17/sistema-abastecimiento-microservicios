...
public class OrdenResponseDTO {
    ...
    public String toString() {
        return "OrdenResponseDTO{idOrden=" + idOrden + ", codigo='" + codigo + "', fechaCreacion=" + fechaCreacion + ", montoTotal=" + montoTotal + ", estado='" + estado + "', nombreProveedor='" + nombreProveedor + "', rucProveedor='" + rucProveedor + "', codigoRequerimiento='" + codigoRequerimiento + "', detalles=" + detalles + "}";
    }
}
