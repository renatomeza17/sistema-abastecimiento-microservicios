...
INSERT INTO pedido_dependencia (codigo, descripcion, estado, fecha_creacion, fecha_actualizacion, id_usuario, id_dependencia, version) VALUES
    ...
    ('PD-2026-002', 'Pedido de equipos de computo para el area de sistemas', 'PENDIENTE', '2026-07-12 11:00:00', '2026-07-13 14:00:00', 2, (SELECT id FROM dependencia WHERE nombre = 'Departamento de Logistica'), 1),
    ('PD-2026-003', 'Pedido de mobiliario para nueva oficina', 'CULMINADO', '2026-07-14 08:30:00', '2026-07-15 10:00:00', 3, (SELECT id FROM dependencia WHERE nombre = 'Departamento de Contabilidad'), 2);
